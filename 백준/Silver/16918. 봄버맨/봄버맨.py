...
# 법칙을 보면, 초가 짝수일 때 빈 자리에 폭탄을 설치함(맨 첫 턴은 쉬기 때문에)
# 반대로 홀수 턴일 때는 설치한지 3초가 지난 폭탄이 폭발하며 십자가 형태로 흔적을 남김(해당 지역 폭탄도 함께 삭제)
# 따라서 이번 문제에서 가장 중요한 것은 '해당 폭탄이 설치된지 얼마나 지났는지'를 프로그램 내에서 파악하게 하는 것임
# 주의할 점은 폭탄 터진 후 그 폭발에 말려든 폭탄도 함께 말려들기 때문에 카운트 세기가 까다롭다는 점 => 제외한다!
